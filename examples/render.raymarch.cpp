...
void main() {
    ...
    if (hit) {
        ...
        vec3 c = vec3(0.3, 0.8, 0.4); // Greenish tree theme
...
int main() {
    ...
    while (!WindowShouldClose()) {
                ...
                for (int x = 0; x < W; ++x) {
                    ...
                    for (int i = 0; i < 64; ++i) {
                        ...
                        if (root_dist_sq > 0.001f) {
                            ...
                            kd3::point_t target = {p.x, p.y, p.z};
                    ...
                    if (hit) {
                        ...
                        Vec3 c = {0.3f, 0.8f, 0.4f}; // Green tree theme matching shader
        ...
        DrawText(TextFormat("Total Points: %d", num_points), 15, 85, 16, WHITE);
        DrawText(TextFormat("Total Nodes:  %d (%d splits, %d leaves)", total_nodes, num_splits, num_leaves), 15, 105, 16, LIGHTGRAY);
